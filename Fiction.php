...
<div class="container">
  <h2 class="c-text text-center my-3">Fiction books</h2>
...
<img src="MTL-images/jasvir.webp" alt="" height="500" width="1100">
 ...
 <div class="album py-5 bg-body-tertiary">
      <div class="container-fluid mx-md-5 cards">
        <h4 class="text-center c-text change bg-primary">FICTION - Books </h4>
        <hr>
        ...
        $per_page_record = 20;  // Number of entries to show in a page.   
          ...
          $query = "SELECT * FROM books where topic = 'Fiction' LIMIT $start_from, $per_page_record";     
          $result = mysqli_query ($con, $query); 
