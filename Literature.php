...
<div class="container">
  <h2 class="c-text text-center my-3">Literature</h2>
  <p class=" mx-5 text-justify">Literature is more than just words—it’s a reflection of our very essence, capturing the vast tapestry of human emotions, experiences, and dreams. Delving into a novel or poem, we embark on journeys that transcend time and space.

While the importance of literature might seem intangible at first, its profound impact on society, culture, and individual souls is undeniable. </p>
</div>
 <div class="album py-5 bg-body-tertiary">
      <div class="container-fluid mx-md-5 cards">
        <h4 class="text-center c-text change bg-primary">Literature - Books </h4>
        <hr>
        ...
        $per_page_record = 10;  // Number of entries to show in a page.   
          ...
          $query = "SELECT * FROM books where topic = 'Literature' LIMIT $start_from, $per_page_record";     
          $result = mysqli_query ($con, $query); 
