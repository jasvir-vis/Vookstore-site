...
<div class="container">
  <h2 class="c-text text-center my-3">MOTIVATIONAL/INSPRING books</h2>
  <p class=" mx-5 text-justify"> They can help inspire creativity when it is needed most, help you take control of your life, and provide you with practical guidance so you can work on achieving your personal and professional goals which ultimately lead to success. Motivational books can also help change the way we think. James argues that the most valuable asset we have and the one which we should be investing the most time, effort, and resources into is — ourselves. This whole book is about how we can achieve success simply by choosing to invest in ourselves and our growth. </p>
</div>
 <div class="album py-5 bg-body-tertiary">
      <div class="container-fluid mx-md-5 cards">
        <h4 class="text-center c-text change bg-primary">Motivational books inspiring the people </h4>
        <hr>
        ...
        $per_page_record = 20;  // Number of entries to show in a page.   
          ...
          $query = "SELECT * FROM books where topic = 'Motivational' LIMIT $start_from, $per_page_record";     
          $result = mysqli_query ($con, $query); 
