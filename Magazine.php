...
<div class="container-fluid ml-5">
  <h2 class="c-text text-center my-3">MAGAZINES</h2>
<img src="MTL-images/large_232384_4HyLeJnOBubSkC2RBwyVd2dn9.jpg" alt="" height="600" width="1400">
</div>
 <div class="album py-5 bg-body-tertiary">
      <div class="container-fluid mx-md-5 cards">
        <h4 class="text-center c-text change bg-primary">FAMOUS MAGAZINES WRITTEN BY CELEBRITIES </h4>
        <hr>
        ...
        $per_page_record = 20;  // Number of entries to show in a page.   
          ...
          $query = "SELECT * FROM books where topic = 'Magazine' LIMIT $start_from, $per_page_record";     
          $result = mysqli_query ($con, $query); 
